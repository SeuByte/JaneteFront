    ...
    <div className="bg-gray-50 text-gray-800 min-h-screen flex flex-col justify-between font-['Inter',_sans-serif]">
      ...
      <div className="max-w-7xl w-full mx-auto px-4 py-8 flex-grow">
        ...
        <div className="text-center mb-2">
          <h1 className="text-2xl font-bold text-gray-900">Alterar Dados Cadastrais</h1>
        </div>

        {/* Breadcrumb */}
        <div className="text-center text-xs text-gray-500 mb-8">
          <Link to="/home" className="hover:underline">Home</Link> &gt;{' '}
          <span className="hover:underline cursor-pointer">Área do Cliente</span> &gt;{' '}
          <span className="text-gray-900 font-medium">Alterar Dados Cadastrais</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 items-start">
          ...
          <aside className="md:col-span-1 border-r border-gray-200 pr-4 space-y-1">
            <Link to="/ultimo-pedido" className="flex items-center space-x-3 p-2.5 text-sm text-gray-600 hover:bg-gray-100 rounded transition-colors">
              <span className="text-lg">☀️</span>
              <span>Último pedido</span>
            </Link>
            
            <Link to="/pedidos" className="flex items-center space-x-3 p-2.5 text-sm text-gray-600 hover:bg-gray-100 rounded transition-colors">
              <span className="text-lg">📄</span>
              <span>Consultar meus pedidos</span>
            </Link>
            
            <Link to="/vale-compra" className="flex items-center space-x-3 p-2.5 text-sm text-gray-600 hover:bg-gray-100 rounded transition-colors">
              <span className="text-lg">🔄</span>
              <span>Vale Compra</span>
            </Link>
            
            <Link to="/cliente" className="flex items-center space-x-3 p-2.5 text-sm font-bold text-gray-900 bg-gray-100 rounded border-l-4 border-gray-900 transition-colors">
              <span className="text-lg">📝</span>
              <span>Alterar dados cadastrais</span>
            </Link>
            
            <Link to="/enderecos" className="flex items-center space-x-3 p-2.5 text-sm text-gray-600 hover:bg-gray-100 rounded transition-colors">
              <span className="text-lg">📍</span>
              <span>Gestão de Endereços</span>
            </Link>
            
            <Link to="/alterar-senha" className="flex items-center space-x-3 p-2.5 text-sm text-gray-600 hover:bg-gray-100 rounded transition-colors">
              <span className="text-lg">🔒</span>
              <span>Alterar senha</span>
            </Link>
            
            <Link to="/alterar-email" className="flex items-center space-x-3 p-2.5 text-sm text-gray-600 hover:bg-gray-100 rounded transition-colors">
              <span className="text-lg">✉️</span>
